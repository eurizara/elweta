...
Este repositorio corresponde a las secciones 3 **Explorando el historial** y 4 **Gestión de ramas**. Y se pone a disposición como material de consulta con el historial completo de esas secciones.
